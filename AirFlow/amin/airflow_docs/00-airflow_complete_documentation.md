...
Generated on: 2025-06-11 08:11:15

Airflow version: 2.9.0

---

# Main Airflow Command
...
```
Usage: airflow config list [-h] [--color {auto,off,on}] [-c] [-a] [-p] [-d]
...
```
Usage: airflow connections get [-h] [--color {off,auto,on}]
...
#### Note: `airflow dags test` requires a DAG ID

Example usage: `airflow dags test [dag_id] [execution_date]`
...
```
Usage: airflow providers get [-h] [--color {auto,on,off}] [-f]
                             [-o table, json, yaml, plain] [-v]
                             provider_name
...
```
Usage: airflow tasks run [-h] [--cfg-path CFG_PATH] [-d {ignore,check,wait}]
...
Optional Arguments:
  ...
  -d, --depends-on-past {ignore,check,wait}
